...
#ifndef COURSEWORK2_DATA_H
#define COURSEWORK2_DATA_H
...
public:
    ...
    */
     ...
     * does not exist.
     */
    void printSubGroup(char g, int sg);


    // Returns the number of items from group g and subgroup sg.
     ...
     */
    Item * getItemByName(char g, int sg, string n);
    /*
     * Returns the pointer to the first of items specified by group g, subgroup sg and timestamp d. If
     * the item was not found returns nullptr.
     */
    Item * getItemByDate(char g, int sg, Date d);
    /*
